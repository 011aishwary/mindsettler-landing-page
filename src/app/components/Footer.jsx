            ...
            <footer className="footer relative bg-Primary-purple text-blueGray border-base-300 border-t px-10 py-4">
                ...
                <nav className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-4">
                        ...
                        <Link href="https://www.youtube.com/@mindsettler" target="_blank" rel="noopener noreferrer">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                        ...
                        <Link href="https://www.facebook.com/mindsettler" target="_blank" rel="noopener noreferrer">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
